...
INSERT INTO `little-lemon-db`.`CustomerDetails` (`CustomerID`, `Names`, `Contacts`)
VALUES
...
INSERT INTO `little-lemon-db`.`StaffInformation` (`StaffID`, `Names`, `Role`, `Salary`)
VALUES
...
INSERT INTO `little-lemon-db`.`Menu` (MenuID, Starters, Cruisines, Courses, Drinks, Desserts, OrderID, BookingID, StaffID)
VALUES
...
INSERT INTO `little-lemon-db`.`Bookings` (`BookingID`, `Date`, `TableNumber`)
VALUES
...
INSERT INTO `little-lemon-db`.`Orders` (OrderID, OrderDate, Quantity, TotalCost, StatusID, CustomerID)
VALUES
...
INSERT INTO `little-lemon-db`.`OrderDeliveryStatuses` (`StatusID`, `DeliveryDate`, `DeliveryStatus`)
VALUES
